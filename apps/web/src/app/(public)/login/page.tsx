    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <div className="max-w-md w-full space-y-8 p-8">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-gray-900 mb-2">revWave</h1>
          <p className="text-gray-600">Digital reputation management</p>
        </div>
        ...
        <div className="mt-8 text-center text-sm text-gray-600">
          <p>New to revWave? Your account will be created automatically.</p>
        </div>
      </div>
    </div>
  );
